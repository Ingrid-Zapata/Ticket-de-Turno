...
document.getElementById('ticketForm').addEventListener('submit', async function (e) {
  ...
  try {
    ...
    resumenDiv.innerHTML = `
      ...
      <p><strong>Nivel:</strong> ${turno.nombre_nivel}</p>
      <p><strong>Municipio:</strong> ${turno.nombre_municipio}</p>
      <p><strong>Asunto:</strong> ${turno.nombre_asunto}</p>
...
document.getElementById('buscarBtn').addEventListener('click', async function() {
  ...
  try {
    ...
    form.nivel.value = turno.nivel.toLowerCase();
    form.municipio.value = turno.municipio.toLowerCase();
    form.asunto.value = turno.asunto.toLowerCase();
